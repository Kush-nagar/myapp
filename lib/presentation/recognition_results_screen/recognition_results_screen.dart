...
class _RecognitionResultsScreenState extends State<RecognitionResultsScreen> {
  ...
  void _retakePhoto() {
    // Navigate to camera screen for retaking photo
    Navigator.pushNamed(context, '/camera-screen').then((result) {
      // If user captures a new photo, replace current results
      if (result != null && result is List<Map<String, dynamic>>) {
        setState(() {
          _recognizedIngredients = result;
          _isLoading = false;
        });
      }
    });
  ...
  void _donateItems() {
    ...
    // Navigate to home screen (keep recognition results in stack so we can return)
    Navigator.pushNamed(
      context,
      '/home-screen',
      arguments: {'donationIngredients': ingredientNames},
    );
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () async {
              if (await _onWillPop()) {
                // Check if we can pop (there's a previous screen in the stack)
                if (Navigator.of(context).canPop()) {
                  Navigator.of(context).pop();
                } else {
                  // If no previous screen, navigate to home/camera screen
                  Navigator.of(context).pushReplacementNamed('/camera-screen');
                }
              }
            },
                    ...
                    child: _isLoading
                        ...
                        : SingleChildScrollView(
                            ...
                            padding: EdgeInsets.only(
                              ...
                              right: 4.w,
                              top: 2.h,
                              bottom: 22.h, // Space for floating buttons
                            ),
                            child: Column(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // First row: Find Recipes and Add More buttons
                      Row(
                        children: [
                          // Find Recipes Button - Green
                          Expanded(
                            child: SizedBox(
                              height: 7.h,
                                ...
                                onPressed: () async {
                                  ...
                                  if (newIngredients != null &&
                                    ...
                                    setState(() {
                                      ...
                                      _recognizedIngredients = dedup.values
                                          .toList();
                                    });
                                  }
                                },
                      ...
                      // Second row: Donate It and Store It buttons
                      Row(
                        children: [
                          // Donate It Button - Orange
                          Expanded(
                            child: SizedBox(
                              height: 7.h,
                              child: ElevatedButton.icon(
