// lib/presentation/recipe_suggestions_screen/widgets/loading_recipes_widget.dart
// Modern, production-ready loading component for Recipe Suggestions
...
/// A professional loading widget that displays animated recipe tips
/// while content is being generated. Implements shimmer effects,
/// skeleton loaders, and smooth animations aligned with app theme.
class LoadingRecipesWidget extends StatefulWidget {
  const LoadingRecipesWidget({super.key});

  @override
  State<LoadingRecipesWidget> createState() => _LoadingRecipesWidgetState();
}

class _LoadingRecipesWidgetState extends State<LoadingRecipesWidget>
  ...
  // Professional tip messages aligned with recipe generation
  static const List<String> _recipeTips = [
    'Analyzing ingredient combinations...',
    'Calculating nutritional values...',
    'Finding perfect flavor pairings...',
  ...
  void _updateTip() {
    final newIndex =
        (_controller.value * _recipeTips.length).floor() % _recipeTips.length;
  ...
  Widget _buildLoadingIcon(ThemeData theme, ColorScheme colorScheme) {
    return Semantics(
      label: 'Loading recipe suggestions',
      liveRegion: true,
      child: SizedBox(
        width: 32.w,
        height: 32.w,
