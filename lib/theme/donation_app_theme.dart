...
/// A class that contains all theme configurations for the food donation application.
/// Implements Contemporary Civic Minimalism design with Warm Professional Palette.
class DonationAppTheme {
  DonationAppTheme._();
  ...
  /// Light theme implementing Contemporary Civic Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      elevation: 4.0, // Material Design elevation level 4
  ...
  /// Helper method to get JetBrains Mono for data display (addresses, phone numbers, operating hours)
