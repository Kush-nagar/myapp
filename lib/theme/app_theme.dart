...
/// Implements Contemporary Culinary Minimalism design approach with
/// warm neutral foundation optimized for food and recipe applications.
class AppTheme {
  AppTheme._();
  ...
  // Background colors optimized for food photography
  ...
  static const Color overlayColor = Color(0x66000000); // 40% opacity black

  // Card colors for recipe cards and content areas
  static const Color cardLight = Color(0xFFFFFFFF);
  static const Color cardDark = Color(0xFF2D2D2D);

  /// Light theme optimized for kitchen environments and food photography
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme with minimal elevation for clean look
    ...
    // Card theme with subtle elevation (2-4dp) for recipe cards
    ...
    // Floating action button for camera functionality
    ...
    // Button themes with adaptive sizing
    ...
    // Input decoration optimized for ingredient entry
    ...
    // Switch theme for dietary preferences
    ...
    // Checkbox theme for ingredient selection
    ...
    // Radio theme for recipe preferences
    ...
    // Progress indicator for nutrition data visualization
    ...
    // Slider theme for serving adjustments
    ...
    // Tab bar theme for recipe categories
    ...
    // Tooltip theme for ingredient information
    ...
    // Snack bar theme for feedback messages
    ...
    // Chip theme for ingredient confidence indicators
  ...
  /// Dark theme optimized for evening cooking sessions
  ...
  /// Optimized for mobile screen clarity and contemporary app aesthetics
